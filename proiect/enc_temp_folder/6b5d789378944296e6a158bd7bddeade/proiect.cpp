...
public:
	...
	void adaugaSala() {
		...
		int i;
		cout << sala << endl;
		cout << "Sala adaugata! Apasa 0 pt a continua" << endl;
		cin >> i;
	}
	...
	void adaugaClient() {
		...
		int i;
		cout << client << endl;
		cout << "Client adaugat! Apasa 0 pt a continua" << endl;
		cin >> i;
	}
	...
	void adaugaAngajat() {
		...
		int i;
		cout << angajat << endl;
		cout << "Angajat adaugat! Apasa 0 pt a continua" << endl;
		cin >> i;
	}
	...
	void adaugaRulare() {
		...
		int i;
		cout << rulare << endl;
		cout << "Rulare adaugata! Apasa 0 pt a continua" << endl;
		cin >> i;
	}
